...
_When new raw data is available please add it to an appropriate year folder and ensure it is following the same naming convention as the other folders._
...
## Scripts
When new raw TOMST data is available it is appropriate to use _Pre-processing_script_TOMST.R_ to re-pre-process the data and print new preprocessed files for the most recent year. The _Pre-processing_script_TOMST.R_ is clearly annotated such that anyone should be able to understand it. 
